...
import { scanForSecrets } from "../skills/agy-review/scripts/lib/secrets.mjs";
...
// secrets.mjs. Writing them literally is what made `/agy:review` exit 4 here.
...
test("the scanner's own source does not trip the scanner", async () => {
  ...
  const source = await readFile(
    new URL("../skills/agy-review/scripts/lib/secrets.mjs", import.meta.url),
    "utf8",
  );
