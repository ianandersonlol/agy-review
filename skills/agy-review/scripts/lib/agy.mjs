...
export const MODEL_DEFAULT = "gemini-3.8-flash-high";
...
// Model ids are lowercase identifiers: gemini-3.8-flash-high, claude-sonnet-4-6,
...
export function parseModelList(stdout) {
  ...
  for (const rawLine of (stdout ?? "").split("\n")) {
    ...
    // version column ("| active-ok | gemini-3.8-flash-high |") mask the real id,
    ...
    // fragments ("3.8") would otherwise pass for ids themselves.
